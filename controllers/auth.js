...
exports.register = asyncHandler(async (req, res, next) => {
    ...
    const { name, email, lastname, password, phone, role } = req.body
    //Create User
    ...
    res.status(200).json({
        success: true, msg: 'New user added'
    })
})
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    if (!user) {
        return next(new ErrorResponse('There in no user with that email'), 404)
    }
